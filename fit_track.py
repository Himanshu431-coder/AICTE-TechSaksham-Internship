...
# 1 this is runs first and initializes everything
    ...
    def __init__(self): # CHANGE FILE PATHS IN THIS FUNCTION LINE (80 - 83)
        ...
        self.workout_csv_path = "C://users//janvi//myproject//workout.csv"
        self.icon_path = "C://users//janvi//myproject//calorie_icon.ico"
        self.calorie_img_path = "C://users//janvi//myproject//calorie_img.png"
        self.workout_logs_csv_path = "C://users//janvi//myproject//workout_logs.csv"
...
# 2 this will greet the user and ask for their info
    ...
    def main_window(self):
        ...
        main_window.title("Calorie_Tracker by Himanshu Tapde")
        ...
        calorie_image = Image.open(self.calorie_img_path).resize((200,200), Image.LANCZOS)
...
print("THIS PROGRAM CALCULATES THE NUMBER OF CALORIES A USER HAS BURNED DURING A WORKOUT, SHOWS THEM AND STORES THEM IN A CSV")
